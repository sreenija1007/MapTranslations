...
import 'package:first/screens/mapsat/show_image2.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import '../exit-popup.dart';
import '../signin_screen.dart';
import 'show_image1.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('map translations',style: TextStyle(
            color: Colors.black
          ),),
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        children: [
                          CircleAvatar(
                            backgroundColor: Color.fromARGB(255, 213, 200, 142),
                            radius: 40,
                            child: IconButton(
                                onPressed: () async {
